...
<head>
    ...
    <?php error_log('>>> theme-' . $this->config->item('theme') . ', ' . $_SERVER['DOCUMENT_ROOT'] . '/public/css/' . $this->config->item('theme') . '.css'); if ($this->config->item('theme') != 'flatly' && file_exists($_SERVER['DOCUMENT_ROOT'] . '/public/css/' . $this->config->item('theme') . '.css')) { ?>
